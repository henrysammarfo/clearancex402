...
function Page() {
  ...
  return (
    <AppShell
      ...
      description="Your vaults and files on the shared Clearance402 registry — connect the same wallet on any device to see your data. Buyers browse all listings."
      actions={
        <>
